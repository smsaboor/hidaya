...
class TimingController {
  ...
  List<String> _litems1 = ["Unknown","Fajr","Dhuhr","Asr","Magrib","Isha"];
  List<String> _litems2 = ["Unknown","Isha","Fajr","Dhuhr","Asr","Magrib"];
  ...
  String get prayer => _litems1[_timingCount+1];
  String get prayerPrevious => _litems2[_timingCount+1];
